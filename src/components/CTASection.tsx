    ...
    <section className="bg-slate-950 text-white py-24 md:py-40 relative overflow-hidden">
      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-normal leading-[1.05] tracking-tight mb-8">
              Start Your AI <br/>
              <span className="text-accentTeal italic">Automation Audit</span>
            </h2>
            <p className="text-white/60 text-lg md:text-xl lg:text-2xl mb-12 font-light max-w-3xl leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/contact"
                className="bg-white text-black px-10 py-5 rounded-full text-base font-semibold hover:bg-accentTeal hover:text-white transition-all shadow-2xl"
              >
                Request Automation Audit
              </Link>
              <Link
                href="/contact"
                className="border border-white/20 text-white px-10 py-5 rounded-full text-base font-semibold hover:bg-white/10 transition-all backdrop-blur-sm"
              >
                Contact TDI
              </Link>
            </div>
