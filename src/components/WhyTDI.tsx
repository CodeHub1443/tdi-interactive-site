        ...
        <div className="lg:hidden grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 w-full">
          {comparisons.map((item, idx) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-white/10 bg-[#010404] transition-all duration-700 hover:border-[#6CF2B0]/50 hover:shadow-[0_0_30px_rgba(108,242,176,0.1)] focus:border-[#6CF2B0]/50 cursor-pointer min-h-[160px] sm:min-h-[140px] focus:outline-none"
            >
              <div className="absolute inset-0 p-5 sm:p-6 flex flex-col justify-between transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:-translate-y-full group-focus:-translate-y-full">
                <div className="inline-flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-500/80 animate-pulse" />
                  <span className="text-[8px] sm:text-[9px] uppercase tracking-widest text-red-400 font-bold">The Problem</span>
                </div>
                <h4 className={`font-light text-white/90 leading-snug tracking-tight ${item.challengeSize}`}>
                  &ldquo;{item.challenge}&rdquo;
                </h4>
              </div>
              <div className="absolute inset-0 p-5 sm:p-6 flex flex-col justify-between bg-[radial-gradient(circle_at_top_right,_rgba(108,242,176,0.15)_0%,_#010404_80%)] transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] translate-y-full group-hover:translate-y-0 group-focus:translate-y-0 opacity-0 group-hover:opacity-100 group-focus:opacity-100">
                <div className="inline-flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#6CF2B0]" />
                  <span className="text-[8px] sm:text-[9px] uppercase tracking-widest text-[#6CF2B0] font-bold">TDI Solution</span>
                </div>
