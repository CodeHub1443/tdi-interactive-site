      ...
      <section className="bg-black py-24 md:py-32 border-b border-white/5">
        <div className="max-w-[1800px] mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/50 text-lg md:text-xl font-light leading-relaxed max-w-3xl">
        ...
        <div className="max-w-[1800px] mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32">
            ...
            <motion.div
              ...
              className="bg-[#0c1414] border border-white/5 rounded-3xl p-10 lg:p-14"
            >
              <h2 className="text-2xl font-normal text-white mb-10">Request a Discovery Session</h2>
              <form className="space-y-8">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea rows={4} className="bg-transparent border border-white/10 p-4 rounded-xl text-white focus:outline-none focus:border-accentTeal transition-colors" placeholder="Tell us about the processes you are looking to automate..." />
                </div>

                <button className="w-full bg-white text-black font-semibold py-5 rounded-full hover:bg-accentTeal hover:text-white transition-all shadow-xl">
