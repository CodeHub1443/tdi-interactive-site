...
export default function ContactClient() {
  ...
  return (
    <main className="pt-20 min-h-screen flex flex-col">
      <section className="bg-black py-8 md:py-12 border-b border-white/5 flex-shrink-0">
        <div className="max-w-[1800px] mx-auto px-6 lg:px-8">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-normal tracking-tight text-white mb-4">
      ...
      <section className="bg-black flex-1 py-8 md:py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      required
                      autoComplete="name"
                      className="bg-transparent border-b border-white/10 py-3 text-white focus:outline-none focus:border-accentTeal transition-colors placeholder:text-white/20"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="bg-transparent border border-white/10 p-3 rounded-xl text-white text-sm focus:outline-none focus:border-accentTeal transition-colors placeholder:text-white/20"
                ...
                <button
                  type="submit"
                  className="w-full bg-white text-black font-semibold py-3.5 rounded-full hover:bg-accentTeal hover:text-white transition-all shadow-xl"
                >
            ...
            >
              <div className="space-y-10">
                <div>
                  <h3 className="text-[10px] uppercase tracking-widest text-accentTeal font-bold mb-6" id="contact-details-heading">Contact Details</h3>
                  <div className="space-y-4" aria-labelledby="contact-details-heading">
                    <a
                      href="mailto:connect@thedataisland.com"
                      className="block text-xl md:text-2xl text-white font-medium hover:text-accentTeal transition-colors"
                    >
